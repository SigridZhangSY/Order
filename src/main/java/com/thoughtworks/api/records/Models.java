...
public class Models extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(MyRepository.class).to(com.thoughtworks.api.records.MyRepository.class);
        bind(ProductRepository.class).to(com.thoughtworks.api.records.ProductRepository.class);
        bind(com.thoughtworks.api.core.UserRepository.class).to(com.thoughtworks.api.records.UserRepository.class);
